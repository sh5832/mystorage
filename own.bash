...
mysql --password=!Intel5832 --user=root --host=localhost << eof
create database ownclouddb;
grant all privileges on ownclouddb.* to root@localhost identified by "!Intel5832";
flush privileges;
exit;
eof
cd /var/www/owncloud
